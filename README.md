...
### Proxmox Dashboard
![Proxmox Dashboard](screenshots/proxmox/proxmox-dashboard-overview.png)

### DC01 VM Hardware Configuration
![DC01 VM Hardware](screenshots/proxmox/dc01-vm-hardware-configuration.png)
...
### DC01 Server Manager
![DC01 Server Manager](screenshots/windows-server/dc01-server-manager-overview.png)
...
### OU Structure
![OU Structure](screenshots/active-directory/active-directory-ou-structure.png)
